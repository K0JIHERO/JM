...
//public class JC429 {
//    public static void moveRobot(testRobot.RobotConnectionManager robotConnectionManager, int toX, int toY) {
//        for (int i = 0; i < 3; i++) {
//            try (testRobot.RobotConnection robotConnection = robotConnectionManager.getConnection()) {
//                robotConnection.moveRobotTo(toX, toY);
//                i = 3;
//            } catch (testRobot.RobotConnectionException e) {
//                if (i==2) {
//                    throw new testRobot.RobotConnectionException("error");
//                }
//            }
//        }
//    }
